    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            if (total != 0) {
                ...
                if (oiledCounter != 0) {
                    output.println("Ghee No: " + oiledCounter + " Price :" + oiledPrice);
                }
                if (floorCounter != 0) {
                    output.println("Flour No: " + floorCounter + " Price :" + floorPrice);
                }
                if (milkCounter != 0) {
                    output.println("Milk No: " + milkCounter + " Price :" + milkPrice);
                }
                output.println("---------------------------------------------------");
